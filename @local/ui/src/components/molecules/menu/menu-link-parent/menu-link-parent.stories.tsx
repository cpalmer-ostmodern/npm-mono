...
MenuLinks.args = {
  twMenuParentLinkWrapper:
    "font-bold font-primary relative block w-full cursor-pointer md:before:content-none before:content-[''] before:bg-left before:absolute before:w-6 before:h-6 before:left-0 before:transform-gpu before:origin-center translate-y-2 before:duration-200 before:ease-in-out",
  ...
  twMenuSubLinkWrapper:
    "font-primary flex flex-col relative gap-2 mt-4 pr-20 md:pr-0 md:w-full md:absolute md:top-0 md:right-full md:before:content-[''] md:before:absolute md:before:w-12 md:before:h-9 md:before:-right-16",
};
